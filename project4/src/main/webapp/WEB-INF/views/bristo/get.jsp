            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="/resources/logoimage.png" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                                                   <a href="#" class="primary-btn" onclick="location.href='/bristo/list.do'">목록으로</a>
                                                   <a href="#" class="primary-btn" onclick="location.href='/cart/registerForm.do?bristokey='+${bristo.bristokey}">식당예약</a>
                                                   <a href="#" class="primary-btn" onclick="location.href='/bristo/delete.do?bristokey='+${bristo.bristokey}">삭제</a>
                        <h3>${bristo.name }</h3>
