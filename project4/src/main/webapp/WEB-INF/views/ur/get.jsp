	...
	<div class="row">
		<div class="col-lg-8 col-md-6">
			<div class="row">
				<div class="col-lg-6">
					<div class="checkout__input">
						...
						<input type="text" name="title" value="${ur.urkey }"
							readonly="readonly">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="checkout__input">
						...
						<input type="number" value="${ur.oppograde }" readonly="readonly">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="checkout__input">
			...
			<div class="checkout__input">
				...
				<textarea rows="20" cols="82" name="content" readonly="readonly">${ur.content }"</textarea>
			</div>
		</div>
	</div>
...
$(document).ready(function () {
	  var urkeyValue = '<c:out value="${ur.urkey}"/>';
	  var replyUL = $(".chat");
	  
	    showList();
	    
	function showList(){
	    replyService.getList({urkey:urkeyValue}, function(list) {
...
$(document).ready(function () {
	...
	var urkeyValue = '<c:out value="${ur.urkey}"/>';
	replyService.add(
		    {reply:"JS Test", replyer:"tester", urkey:urkeyValue}
		    ,
		    function(result){ 
		      alert("RESULT: " + result);
		    }
